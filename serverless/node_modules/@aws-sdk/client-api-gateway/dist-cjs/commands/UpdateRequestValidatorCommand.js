...
class UpdateRequestValidatorCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, UpdateRequestValidatorCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.se_UpdateRequestValidatorCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.de_UpdateRequestValidatorCommand)(output, context);
    }
}
