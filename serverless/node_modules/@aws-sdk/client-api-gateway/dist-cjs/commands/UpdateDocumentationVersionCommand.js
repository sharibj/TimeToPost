...
class UpdateDocumentationVersionCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, UpdateDocumentationVersionCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_restJson1_1.se_UpdateDocumentationVersionCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restJson1_1.de_UpdateDocumentationVersionCommand)(output, context);
    }
}
